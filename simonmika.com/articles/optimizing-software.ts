...
export const optimizingSoftware: model.Site.Page = {
	date: "2016-11-24T08:15:46+02:00",
	tags: ["software optimization", "performance"],
	title: "Optimizing Software",
	content: `Many programmers, especially those early in their careers, focus heavily on optimizing their code for _execution speed_. They do this because they take pride in their work and want to do it well - which is admirable. However, when programmers optimize for speed, they often get it wrong, particularly when applying _theoretical concepts_ learned in university algorithm courses.
