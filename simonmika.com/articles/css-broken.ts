...
export const cssBroken: model.Site.Page = {
	date: "2016-08-18T23:18:43+02:00",
	tags: ["web"],
	title: "CSS is Still Broken",
	content: `The purpose of CSS is to describe the presentation of a document. It is created to enable [separation of presentation and content](https://en.wikipedia.org/wiki/Separation_of_presentation_and_content). So far CSS has been improving the situation. We have been able to move more and more presentation out of our documents and into CSS.
