...
export const Head: FunctionalComponent<Head.Properties> = ({ url, title, description, image, design }) => {
	const result: HTMLElement[] = (
		[
			...
			{ tag: "meta", attributes: { property: "og:url", content: url } },
